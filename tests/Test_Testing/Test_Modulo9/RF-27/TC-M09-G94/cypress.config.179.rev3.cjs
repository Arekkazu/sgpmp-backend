...
module.exports = defineConfig({
  ...
  screenshotsFolder: path.join(outDir, 'screenshots-179-rev3-test'),
  viewportWidth: 1440,
  viewportHeight: 900,
  retries: 0,
  ...
  reporterOptions: {
    reportDir: outDir,
    reportFilename: 'TC-M09-G94_179_rev3_test',
    overwrite: true,
    html: true,
    json: true,
    charts: true,
  ...
  e2e: {
    ...
    specPattern: path.join(__dirname, 'tc_m09_g94_179_rev3_test.cy.js'),
