...
$Collection = Join-Path $TestDir "tc_m02_g08.json"

$ResultsDir = Join-Path $TestDir "Resultados"

$Report = Join-Path $ResultsDir "TC-M02-G08-Newman.html"

Write-Host ""
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "   EJECUCION TC-M02-G08 - RF-33" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
