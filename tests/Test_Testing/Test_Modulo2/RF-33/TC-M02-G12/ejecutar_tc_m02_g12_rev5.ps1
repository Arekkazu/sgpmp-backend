# TC-M02-G12 rev5 RF-33. Password via SGPMP_TEST_PASSWORD o CONTRASENA.
# No sobrescribe revision3 ni rev2.

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$CollectionFile = Join-Path $ScriptDir "tc_m02_g12_rev5.json"
$EnvironmentFile = Join-Path $ScriptDir "environment-g12-rev5.json"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlReport = Join-Path $ResultadosDir "TC-M02-G12-rev5-evidencia.html"
$JsonReport = Join-Path $ResultadosDir "TC-M02-G12-rev5.json"
$TxtReport = Join-Path $ResultadosDir "TC-M02-G12-rev5.txt"
...
Write-Log "TC-M02-G12 rev5 RF-33 TEST"
