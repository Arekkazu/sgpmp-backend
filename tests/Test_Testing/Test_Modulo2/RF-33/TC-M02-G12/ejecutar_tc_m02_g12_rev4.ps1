# TC-M02-G12 rev4 RF-33. Password via SGPMP_TEST_PASSWORD o CONTRASENA.
# No sobrescribe revision3 ni rev2.

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$CollectionFile = Join-Path $ScriptDir "tc_m02_g12_rev4.json"
$EnvironmentFile = Join-Path $ScriptDir "environment-g12-rev4.json"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlReport = Join-Path $ResultadosDir "TC-M02-G12-rev4-evidencia.html"
$JsonReport = Join-Path $ResultadosDir "TC-M02-G12-rev4.json"
$TxtReport = Join-Path $ResultadosDir "TC-M02-G12-rev4.txt"
...
Write-Log "TC-M02-G12 rev4 RF-33 TEST"
