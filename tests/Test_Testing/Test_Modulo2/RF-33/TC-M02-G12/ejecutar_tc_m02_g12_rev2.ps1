# TC-M02-G12 rev2 RF-33. Password via SGPMP_TEST_PASSWORD o CONTRASENA.

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$CollectionFile = Join-Path $ScriptDir "tc_m02_g12_rev2.json"
$EnvironmentFile = Join-Path $ScriptDir "environment-g12-rev2.json"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlReport = Join-Path $ResultadosDir "TC-M02-G12-rev2-Newman.html"
$JsonReport = Join-Path $ResultadosDir "TC-M02-G12-rev2.json"
$TxtReport = Join-Path $ResultadosDir "TC-M02-G12-rev2-ejecucion.txt"
...
Write-Log "TC-M02-G12 rev2 RF-33 TEST - INC-M02-45-G12"
