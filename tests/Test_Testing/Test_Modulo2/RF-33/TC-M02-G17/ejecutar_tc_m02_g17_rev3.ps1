# TC-M02-G17 rev3. No modifica rev1/rev2, RF-16 ni backend.
$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RepoRoot = (Resolve-Path (Join-Path $ScriptDir "..\..\..\..\..")).Path
$TestFile = Join-Path $ScriptDir "test_tc_m02_g17_rev3.py"
$CollectionFile = Join-Path $ScriptDir "tc_m02_g17_rev3.json"
$EnvironmentFile = Join-Path $ScriptDir "environment-g17-rev3.json"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlPytest = Join-Path $ResultadosDir "TC-M02-G17-rev3-pytest.html"
$TxtLog = Join-Path $ResultadosDir "TC-M02-G17-rev3-pytest.txt"
$HtmlNewman = Join-Path $ResultadosDir "TC-M02-G17-rev3-Newman.html"
$JsonNewman = Join-Path $ResultadosDir "TC-M02-G17-rev3-Newman.json"
$TxtNewman = Join-Path $ResultadosDir "TC-M02-G17-rev3-Newman.txt"
...
Set-Content -LiteralPath $TxtNewman -Value "TC-M02-G17 rev3 Newman (GET metricas; mutaciones en pytest)." -Encoding UTF8
