# TC-M02-G13 rev3 RF-33. Password via SGPMP_TEST_PASSWORD o CONTRASENA.
# No sobrescribe rev2 ni historico.

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$CollectionFile = Join-Path $ScriptDir "tc_m02_g13_rev3.json"
$EnvironmentFile = Join-Path $ScriptDir "environment-g13-rev3.json"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlReport = Join-Path $ResultadosDir "TC-M02-G13-rev3-Newman.html"
$JsonReport = Join-Path $ResultadosDir "TC-M02-G13-rev3.json"
$TxtReport = Join-Path $ResultadosDir "TC-M02-G13-rev3-ejecucion.txt"
...
Write-Log "TC-M02-G13 rev3 RF-33 TEST - INC-M02-46-G13"
Write-Log "Coleccion: $CollectionFile"
Write-Log "Fecha UTC: $([DateTime]::UtcNow.ToString('o'))"
Write-Log "Usuario: $Correo. Password via env. No sobrescribe rev2."
Write-Log ""
