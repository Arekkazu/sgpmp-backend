# TC-M02-G18 rev3 RF-34. Datos DBA TEST. No modifica historico ni rev2.
# Password via SGPMP_TEST_PASSWORD o CONTRASENA.

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$RepoRoot = (Resolve-Path (Join-Path $ScriptDir "..\..\..\..\..")).Path
$TestFile = Join-Path $ScriptDir "test_tc_m02_g18_rev3.py"
$ResultadosDir = Join-Path $ScriptDir "Resultados"
$HtmlPytest = Join-Path $ResultadosDir "TC-M02-G18-rev3-pytest.html"
$TxtLog = Join-Path $ResultadosDir "TC-M02-G18-rev3-pytest.txt"
