...
> **Estado (2026-09-23): M1, M9 y M2 están corregidos; solo quedan abiertos RF-52 E3 y E5 de M2.**
...
>   RF-49 dispositivo desconectado (#377) y RF-50 NIC 41 (#424). Siguen abiertos RF-52 E3 (cola con
>   prioridad) y E5 (reconciliación RF-46↔RF-52), que necesitan decisiones de Análisis.
...
| M2 — Biological Assets | 17 (+3 sin ficha) | 104 | 18 | **2** | 4 → **0** |
| **Total** | **46** | **312** | **38** | **2** | **23** |
...
Las filas marcadas ✅ ya están corregidas: las 15. De RF-52 (fila 2) queda abierto lo que no es
contrato HTTP: E3 y E5.
...
| 2 | ✅ M2 · RF-52 (E1, E2) | `registro_incompleto` nunca se activa — un campo faltante se rechaza (400) en vez de aceptarse-con-advertencia; sin buffer de auditoría ni cola con prioridad. *E3 (cola con prioridad) y E5 (reconciliación) siguen abiertos* | Funcionalidad ausente |
...
implementaron los outliers de RF-50/RF-51 y E1/E2 de RF-52. Lo único abierto en toda la auditoría
es RF-52 E3 y E5: requieren decisiones de Análisis (umbral de "alta carga" y bitácora asíncrona;
llave de cruce `id_evento` entre RF-46 y RF-52), no solo código.
